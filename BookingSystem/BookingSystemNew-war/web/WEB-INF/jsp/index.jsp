        ...
        <div id="fh5co-wrapper">
            <div id="fh5co-page">
                                ...
                                <form action="#">
                                   ...
                                   <!-- <div class="a-col">
                                    ...
                                    <div class="a-col action">
                                        <button type="submit" name="submitViewAvailability" id="submitViewAvailability"> <a href="#">
                                            <span>Check</span>
                                            Availability
                                            </a> </button>
                                    </div>
                                             ...
                                             <% 
                                               InitialContext ic4 = new InitialContext();
                                                Object d = ic4.lookup(EntityAccessorBeanRemote.class.getName());
                                                ...
                                                List<Room> roomDates = null;
                                                request.setAttribute("rooms", rooms);

                                                if (request.getParameter("submitViewAvailability") != null) {
                                                   ...
                                                   Date DBDate = (Date)newFormat.parse(newDate);
                                                   // returns null
                                                   // roomDates = adminSession.getAvailableRoomsForDate(DBDate);
                                                  
                                                   // set to full list of rooms to prove no issue with modal
                                                   //request.setAttribute("rooms", roomDates);                                                   %>
                                                               <script language="JavaScript">
                                                    $(document).ready(function() {
                                                       $('#viewAvailableRooms').modal('show');                                                    });
                                                             </script>
                ...
                <footer id="footer" class="fh5co-bg-color">
                                ...
                                <div class="modal-body">
                                    <form method = "get" action ="#">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lastName" name="BookLastName">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email address:</label>
                                            <input type="email" class="form-control" id="bookEmail" name="bookEmail">
                                        </div>
                                        <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!--<input type="text" class="form-control" id="roomNum" name="roomNum"> -->
                                             <select class="cs-select cs-skin-border" name = "roomNum">
                                                <option value="" disabled selected>Room Type</option>
                                                <% InitialContext ic10 = new InitialContext();
                                              
                                                Object Z = ic10.lookup(EntityAccessorBeanRemote.class.getName());
                                                EntityAccessorBeanRemote entitySession10 = (EntityAccessorBeanRemote) Z;
                                                
                                                // gets list of all rooms
                                                List<Room> roomsChoice = entitySession10.getAll(Room.class);
                                                // prints each room from the list
                                               
                                                for (Room singleRoom : roomsChoice) {
                                                    //out.println("<h1>" + singleRoom.getRoomName() +"</h1><input type='radio' name='gender' value ="+ "'" + singleRoom.getRoomName() + "' ></input><br>");
                                                    out.println("<option style='color:red'value ="+ "'" + singleRoom.getRoomName() + "' >"+ singleRoom.getRoomName()+"</option>"+"<br>");
                                    ...
                                    <%             InitialContext ic9 = new InitialContext();
                                        Object X = ic9.lookup(EntityAccessorBeanRemote.class.getName());
                                        EntityAccessorBeanRemote entitySession9 = (EntityAccessorBeanRemote) X;

                                        if (request.getParameter("BookLastName") != null && request.getParameter("firstName") != null && request.getParameter("bookEmail") != null && request.getParameter("DateIn") != null && request.getParameter("DateOut") != null) {
                                            
                                            Reservation reservation = new Reservation();
                                            String dateIn = request.getParameter("DateIn");
                                            DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
                                            Date DateIn = df.parse(dateIn);
                                            
                                            String dateOut = request.getParameter("DateOut");
                                            DateFormat DF = new SimpleDateFormat("yyyy-MM-dd");
                                            Date DateOut = DF.parse(dateOut);
                                            
                                            reservation.setDateIn(DateIn);
                                            reservation.setDateOut(DateOut);
                                           String selectedRoom = request.getParameter("roomNum");
                                           Room selectedRoomObject = entitySession9.namedQuery("Room.findByRoomName", "roomName", selectedRoom);
                                           
                                           //Room room = new Room();
                                            //room.getId();
                                           reservation.setRoomId(selectedRoomObject);
                                            reservation.setPaymentCollection(null);
                                            reservation.setCustomerId(null);
                                            //Customer customer = new Customer();
                                            //customer.getId();
                                            //reservation.setCustomerId(customer);
                                            entitySession9.insert(reservation);
                    ...
                    <div id="viewAvailableRooms" class="modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">View Available Rooms</h4>
            </div>
        <div class="modal-body">
        <form method="get">
            <div class="form-group">
            ...
            <div class="form-group text-center">
               <button type="submit" class="btn btn-default" name="submitViewRooms" id="submitViewRooms">Submit</button>
            </div>
        </form>
      </div>
    </div>
